...
// class UserRecipeDetailPage extends ConsumerWidget {
...
//     final publicUserData = useProvider(
...
//     return Scaffold(
//       body: publicUserData == null && userData == null
//           ? Center(
...
//                         ),
//                         SizedBox(height: 16.0),
//                         if (userRecipe.tags.length > 0)
//                           Text(
//                             'Tags',
//                             style: Theme.of(context).textTheme.headline6,
//                           ),
//                         if (userRecipe.tags.length > 0) SizedBox(height: 16.0),
//                         if (userRecipe.tags.length > 0)
//                           Wrap(
//                             spacing: 8.0,
//                             runSpacing: 4.0,
...
//                           ),
//                         ),
//                         if (userRecipe.steps.length > 0) SizedBox(height: 16.0),
